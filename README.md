...
##Библиотеки:
#include <stdio.h>     - подключение работы ввода-вывода
#include <stdlib.h>    - подключение базовых функций С (в моем примере - calloc)
#include <sys/types.h> - определение новых типов данных для работы со структурой stat 
#include <sys/stat.h>  - определение структуры stat
#include <assert.h>    - кто не ставит ассерты - тот на завтрак ест десерты
